...
def send_student_notification(request): 
    ...
    try:
        notification = NotificationStudent(student=student, message=message, email=email)
        notification.save()
        subject = 'New Notification'
        message = f'You have a new notification: {message}'
        from_email = 'iamafzashafeeque@gmail.com'
...
def send_staff_notification(request):
    ...
    try:
        notification = NotificationStaff(staff=staff, message=message, email=email)
        notification.save()
        subject = 'New Notification'
        message = f'You have a new notification: {message}'
        from_email = 'iamafzashafeeque@gmail.com'
